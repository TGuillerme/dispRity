...
However, because of the infrastructure of the package (especially the one of the `dispRity` objects – see the [`dispRity` manual](https://github.com/TGuillerme/dispRity/blob/master/doc/dispRity-manual.Rmd)), the `metric` argument has to follow certain rules:
