...
It is also possible to apply some more *complex* tests that have their own output classes (like `stats::aov`).

<!-- NC: again this  needs to be lm, aov is not appropriate. Will let you fix this -->
