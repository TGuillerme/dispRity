...
<!-- NC: probably should cite Matt Wills' paper for the centroid thing too as he invented it apparently; TG: ok fixed. Though one can argue Euclides invented it before him (and probably Gnut-the-enlighted-cavemen before-->
...
<!-- NC: I think when these prelim steps have been done a long time earlier, and/or are not built into the package, you probably want to include the code to get boot_time_slices here too. Most people won't read the manual cover to cover in one go -->
...
The resulting disparity object being of dimension-level 2, it can easily be transformed into a dimension-level 1 one by, for example, measuring the median distance of all these distributions:
...
Disparity analyses are not restricted to palaeobiology analysis only.
