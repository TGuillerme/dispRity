...
For more details on this algorithm please refer to the [metric vignette](https://github.com/TGuillerme/dispRity/blob/master/doc/dispRity-metric.Rmd).
...
See the [associated vignette](https://github.com/TGuillerme/dispRity/blob/master/doc/dispRity-simulate_data.Rmd) for more details.
