...
plot(disp_crown_stemBS, type = "lines", rarefaction = 20)
...
It is also possible to easily look at the behaviour of the disparity metric with the rarefied data (i.e. how does the disparity score change when the number of elements goes down) by using the `rarefaction = TRUE` argument:
...
plot(disp_crown_stemBS, elements = TRUE, rarefaction = TRUE)
