...
plot(disp_crown_stemBS, type = "discrete", diversity = TRUE, rarefaction = 20, ylim = c(25,40))
@
...
## The disparity-through-time data in a time-binned way
...
par(new = TRUE)
plot(disp_time_binsBS, type = "discrete", discrete_type = "line", ylim=c(0.5,2), xlab="", ylab="")
@
...
<<plot5, fig.width=5, fig.height=5, out.width='.5\\linewidth'>>=
## Graphical options
par(bty = "n")
