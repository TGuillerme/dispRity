...
plot(disp_crown_stemBS, diversity = TRUE, ylim = c(25,40))
## Same one with rarefied data (note how that affects the diversity data as well!)
plot(disp_crown_stemBS, diversity = TRUE, rarefaction = 20, ylim = c(25,40))
@
...
plot(disp_crown_stemBS, diversity = TRUE, rarefaction = "plot")
...
## boxes)
plot(disp_time_binsBS, discrete_type = "line")
