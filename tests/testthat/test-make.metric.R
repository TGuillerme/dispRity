...
test_that("Output is correct", {
    ...
    expect_equal(make.metric(mean, silent=TRUE), list(type = "level1", tree = FALSE, dist.help = NULL))
    expect_equal(make.metric(ranges, silent=TRUE), list(type = "level2", tree = FALSE, dist.help = NULL))
    expect_equal(make.metric(var, silent=TRUE), list(type = "level3", tree = FALSE, dist.help = NULL))
    expect_equal(
    ...
    expect_equal(make.metric(between.groups.metric, silent = TRUE, check.between.groups = TRUE), list("type" = "level1", "between.groups" = TRUE, "tree" = FALSE, "dist.help" = NULL))
    expect_equal(make.metric(between.groups.metric2, option = FALSE, silent = TRUE)$type, "level2")
    expect_equal(make.metric(between.groups.metric2, option = "bla", silent = TRUE, check.between.groups = TRUE), list("type" = "level2", "between.groups" = TRUE, "tree" = FALSE, "dist.help" = NULL))
    expect_equal(make.metric(mean, silent = TRUE, check.between.groups = TRUE), list("type" = "level1", "between.groups" = FALSE, "tree" = FALSE, "dist.help" = NULL))
    ...
    expect_equal(make.metric(normal.metric, tree = rtree(5), silent = TRUE), list(type = "level1", tree = TRUE, "dist.help" = NULL))
    expect_equal(make.metric(normal.metric2, phy = rtree(5), silent = TRUE), list(type = "level1", tree = FALSE, "dist.help" = NULL))
    expect_equal(make.metric(between.groups.metric, tree = rtree(5), silent = TRUE, check.between.groups = TRUE), list("type" = "level2", "between.groups" = TRUE, tree = TRUE, "dist.help" = NULL))
    expect_equal(make.metric(between.groups.metric2, phy = rtree(5), silent = TRUE, check.between.groups = TRUE), list("type" = "level2", "between.groups" = TRUE, tree = FALSE, "dist.help" = NULL))
    expect_equal(make.metric(normal.metric, silent = TRUE), list(type = "level1", tree = TRUE, "dist.help" = NULL))
    expect_equal(make.metric(normal.metric2, silent = TRUE), list(type = "level1", tree = FALSE, "dist.help" = NULL))
