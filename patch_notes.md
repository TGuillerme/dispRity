...
* 2017/01/?? - v0.3.0 *dispRity lite!*
  * Complete change of the `dispRity` object architecture! `dispRity` objects are now much smaller in size, see more [here](https://github.com/TGuillerme/dispRity/blob/master/disparity_object.md).
