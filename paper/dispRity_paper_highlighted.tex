...
\noindent \texttt{> test.dispRity(disparity2, test = adonis.dispRity)}
...
\begin{tabular}{lrrrrrr}
  ...
  \hline
   ...
   \hline
\end{tabular}
\caption{Permanova output from \texttt{adonis.dispRity}:\\
...
Thanks to David Bapst, Martin Brazeau, Andrew Jackson, Graeme Lloyd and Emma Sherratt for specific implementation ideas 
\hl{and to Michael Collyer, Gavin Simpson and two other anonymous reviewers for constructive and encouraging comments on the manuscript}. %TG: add Graeme Lloyd, Dave Bapst and Emma Sherratt
