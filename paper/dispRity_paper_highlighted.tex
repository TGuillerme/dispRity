...
\begin{abstract} 
    ...
    \begin{enumerate}
        ...
        It is then possible to use summary metrics for measuring some properties of this space for some group of species and compare them.
        ...
        This can unfortunately hamper researchers to apply different methods that \hl{best suits} their specific questions.
