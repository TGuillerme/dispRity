...
#'
#' @param data1 An ordinated matrix of maximal dimensions \eqn{k*(k-1)}, or a \code{dispRity} object (see details).
#' @param data2 An optional matrix of maximal dimensions \eqn{k*(k-1)}, or a \code{dispRity} object (see details). If missing \code{data1} will be cleaned.
