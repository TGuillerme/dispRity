...
#' @param translate \code{logical}, whether to translate the characters following the \emph{xyz} notation (\code{TRUE} - default; see details - Felsenstein 2004) or not (\code{FALSE}). Translation works for up to 26 tokens per character. \emph{NOTE:} if you are comparing taxa, not characters (e.g. if you are using \code{by.col = FALSE}), or \code{t(matrix)}) you might want to use \code{translate = FALSE}.
