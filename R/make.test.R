# #' @title Creating disparity tests
# #'
# #' @description Testing whether a function can be passed to \code{test.dispRity}
# #'
...
# #' make.metric(my_fun)
# #'
# #' @seealso \code{\link{dispRity}}, \code{\link{test.dispRity}}.
# #'
# #' @author Thomas Guillerme


# make.test<-function(fun, ..., silent = FALSE) {
#     #Sanitizing
#     #fun
