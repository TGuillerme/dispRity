 ...
 * `$call$subsamples`: a vector of `character` with information on the subsamples type (either `"continuous"`, `"discrete"` or `"custom"`) and their eventual model (`"acctran"`, `"deltran"`, `"punctuated"`, `"gradual"`). This element generated only once via `time.subsamples()` and `custom.subsamples()`.
