...
> This functionality is not available on the CRAN version of the package (1.0.3)<!-- versiontagCRAN --> due to CRAN compatibility issues see [to CRAN or not to CRAN?](#noCRAN) for more information and on how to install the GitHub (more complete) version of the package (1.1)<!-- versiontagGH -->.
