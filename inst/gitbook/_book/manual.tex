...
\includegraphics{manual_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-15-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-47-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-49-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-50-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-51-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-57-1.pdf}
...
\KeywordTok{data}\NormalTok{(McClean_data)}

\NormalTok{## Ordinated matrix}
\NormalTok{ordinated_matrix <-}\StringTok{ }\NormalTok{McClean_data}\OperatorTok{$}\NormalTok{ordination}

\NormalTok{## Treatments and depths}
\NormalTok{treatments <-}\StringTok{ }\NormalTok{McClean_data}\OperatorTok{$}\NormalTok{treatment}
\NormalTok{depth <-}\StringTok{ }\NormalTok{McClean_data}\OperatorTok{$}\NormalTok{depth}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-62-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-72-1.pdf}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-83-1.pdf}
...
\KeywordTok{min}\NormalTok{(}\KeywordTok{unlist}\NormalTok{(}\KeywordTok{lapply}\NormalTok{(boot_bin_morphospace}\OperatorTok{$}\NormalTok{subsamples, lapply, nrow)))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{manual_files/figure-latex/unnamed-chunk-90-1.pdf}
