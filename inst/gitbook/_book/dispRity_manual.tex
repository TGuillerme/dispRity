...
\NormalTok{my_tree <-}\StringTok{ }\KeywordTok{makeNodeLabel}\NormalTok{(}\KeywordTok{rtree}\NormalTok{(}\DecValTok{5}\NormalTok{), }\DataTypeTok{prefix =} \StringTok{"n"}\NormalTok{)}
...
\KeywordTok{rownames}\NormalTok{(dummy_space2) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(my_tree}\OperatorTok{$}\NormalTok{tip.label,}
\NormalTok{                            my_tree}\OperatorTok{$}\NormalTok{node.label)}
...
\NormalTok{ancestral_dist <-}\StringTok{ }\KeywordTok{dispRity}\NormalTok{(dummy_space2, }\DataTypeTok{metric =}\NormalTok{ ancestral.dist,}
                           \DataTypeTok{tree =}\NormalTok{ my_tree)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## Adding a extra row to dummy matrix (to match dummy_tree)}
\NormalTok{tree_space <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(dummy_space, }\DataTypeTok{root =} \KeywordTok{rnorm}\NormalTok{(}\DecValTok{5}\NormalTok{))}
\CommentTok{## Creating a random dummy tree (with labels matching the ones from tree_space)}
\NormalTok{dummy_tree <-}\StringTok{ }\KeywordTok{rtree}\NormalTok{(}\DecValTok{6}\NormalTok{)}
\NormalTok{dummy_tree}\OperatorTok{$}\NormalTok{tip.label <-}\StringTok{ }\KeywordTok{rownames}\NormalTok{(tree_space)[}\DecValTok{1}\OperatorTok{:}\DecValTok{6}\NormalTok{]}
\NormalTok{dummy_tree}\OperatorTok{$}\NormalTok{node.label <-}\StringTok{ }\KeywordTok{rownames}\NormalTok{(tree_space)[}\KeywordTok{rev}\NormalTok{(}\DecValTok{7}\OperatorTok{:}\DecValTok{11}\NormalTok{)]}

\CommentTok{## Measuring the disparity as the projection of each element}
\CommentTok{## on its root-ancestor vector}
\KeywordTok{summary}\NormalTok{(}\KeywordTok{dispRity}\NormalTok{(tree_space, }\DataTypeTok{metric =}\NormalTok{ projections.tree,}
                             \DataTypeTok{tree   =}\NormalTok{ dummy_tree,}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## A user defined function that's returns the centroid of}
\CommentTok{## the first three nodes}
\NormalTok{fun.root <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(matrix, tree, }\DataTypeTok{row =} \OtherTok{NULL}\NormalTok{) \{}
...
\NormalTok{                                            tree_space[}\DecValTok{1}\NormalTok{, ])))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{dispRity_manual_files/figure-latex/unnamed-chunk-147-1.pdf}
...
\includegraphics{dispRity_manual_files/figure-latex/unnamed-chunk-150-1.pdf}
