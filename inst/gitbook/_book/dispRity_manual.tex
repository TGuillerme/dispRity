...
This is mainly because some parts are still in development and that the
reactivity of GitHub is better for implementing new suggestions from
users. However, the package follows the strict (and useful!) CRAN
standards via Travis.
...
## Consistency index          0.9615385
## Retention index            0.9897959
## Robinson-Foulds distance   0.0000000
\end{verbatim}
