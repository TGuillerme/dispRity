...
Note this uses the \texttt{release} branch (1.2.3). For the piping-hot
...
\item
  ...
  not include some functionalities such as this gitbook vignette because
  of compatibility issues with the CRAN requirement.
\item
...
(1.2.3) due to CRAN compatibility issues see
...
\end{minipage} & \begin{minipage}[t]{0.61\columnwidth}\raggedright\strut
The ratio between the distance from a reference and the distance from
the centroid\strut
\end{minipage} & \begin{minipage}[t]{0.11\columnwidth}\raggedright\strut
\texttt{dispRity}\strut
\end{minipage}\tabularnewline
...
\end{minipage} & \begin{minipage}[t]{0.61\columnwidth}\raggedright\strut
The distance to specific neighbours (e.g.~the nearest neighbours - by
default)\strut
\end{minipage} & \begin{minipage}[t]{0.11\columnwidth}\raggedright\strut
\texttt{dispRity}\strut
\end{minipage}\tabularnewline
...
(\(\displaystyle\prod_{i=1}^{k}R_{i}\) - for a hyper-ellipsoid), and
...
\subsubsection{Ranges, variances, quantiles, radius, pairwise distance,
neighbours, modal value and
diagonal}\label{ranges-variances-quantiles-radius-pairwise-distance-neighbours-modal-value-and-diagonal}
...
\texttt{ranges}, \texttt{variances} \texttt{quantiles} and
\texttt{radius} work on the same principle and measure the
range/variance/radius of each dimension:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## Calculating the quantiles of each dimension in the ordinated space}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## By default, the quantile calculated is the 95% (i.e. 95% of the data on each axis)}
\NormalTok{## this can be changed using the option quantile:}
...
The pairwise distances and the neighbours distances uses the function
\texttt{vegan::vegdist} and can take the normal \texttt{vegdist}
options:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## The average nearest neighbour distances}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## The average furthest neighbour manhattan distances}
...
\subsubsection{Centroids, displacements, and ancestral distance
metrics}\label{centroids-displacements-and-ancestral-distance-metrics}
...
The \texttt{displacements} distance is the ratio between the
\texttt{centroids} distance and the \texttt{centroids} distance with
\texttt{centroid\ =\ 0}. Note that it is possible to measure a ratio
from another point than \texttt{0} using the \texttt{reference}
argument. It gives indication of the relative displacement of elements
in the multidimensional space: a score \textgreater{}1 signifies a
displacement \emph{away} from the reference. A score of \textgreater{}1
signifies a displacement \emph{towards} the reference.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## The relative displacement of the group in space to the centre}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{## The relative displacement of the group to an arbitrary point}
...
\begin{verbatim}
##   subsets  n   obs bs.median  2.5%   25%   75% 97.5%
## 1     120  5 2.823     2.329 1.570 2.060 2.593 2.823
## 2      80 19 3.233     3.038 2.779 2.967 3.122 3.235
## 3      40 15 3.359     3.167 2.775 3.049 3.252 3.402
## 4       0 10 4.055     3.672 3.207 3.541 3.771 3.927
\end{verbatim}
...
\begin{verbatim}
##   subsets  n   obs bs.median  2.5%   25%   75% 97.5%
## 1   crown 30 1.995     1.935 1.867 1.918 1.946 1.976
## 2   crown 29    NA     1.933 1.864 1.910 1.951 1.976
## 3   crown 28    NA     1.933 1.873 1.910 1.950 1.968
## 4   crown 27    NA     1.927 1.854 1.912 1.946 1.977
## 5   crown 26    NA     1.927 1.866 1.909 1.950 1.985
## 6   crown 25    NA     1.929 1.863 1.908 1.954 1.976
\end{verbatim}
...
\tightlist
\item
  \texttt{quantiles} values for the confidence interval levels (by
...
## 1     120  5 2.823 0.350 1.738 2.663
## 2      80 19 3.233 0.118 2.832 3.200
## 3      40 15 3.359 0.173 2.818 3.386
## 4       0 10 4.055 0.193 3.345 3.909
\end{verbatim}
...
\begin{verbatim}
##   subsets  n     obs bs.median    2.5%     25%     75%   97.5%
## 1     120  5 2.82292   2.32886 1.56998 2.05989 2.59325 2.82292
## 2      80 19 3.23312   3.03809 2.77859 2.96734 3.12209 3.23466
## 3      40 15 3.35947   3.16684 2.77533 3.04936 3.25215 3.40197
## 4       0 10 4.05457   3.67236 3.20652 3.54095 3.77150 3.92712
\end{verbatim}
...
## 
## data:  dots[[1L]][[1L]] and dots[[2L]][[1L]]
## t = 60.553, df = 163.34, p-value < 2.2e-16
...
## 1     120  5      1.508     1.325 0.729 1.109 1.554 1.863
## 2      80 19      1.790     1.685 1.368 1.575 1.815 1.950
## 3      40 15      1.689     1.678 1.314 1.574 1.838 2.065
## 4       0 10      1.910     1.808 1.366 1.680 1.963 2.093
\end{verbatim}
...
\begin{verbatim}
##   subsets  n   obs bs.median  2.5%   25%   75% 97.5%
## 1     120  5