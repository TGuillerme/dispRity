...
\item
  The build status:
  \href{https://travis-ci.org/TGuillerme/dispRity}{\includegraphics{https://travis-ci.org/TGuillerme/dispRity.svg?branch=master}}
  which tests whether the package compiles (i.e.~can be installed on
  your computer).
\item
  The code coverage:
  \href{https://codecov.io/gh/TGuillerme/dispRity}{\includegraphics{https://codecov.io/gh/TGuillerme/dispRity/branch/master/graph/badge.svg}}
  which indicates the percentage of lines in the code that have been
  tested for expected behaviour.
\item
  The project status:
  \href{http://www.repostatus.org/\#active}{\includegraphics{http://www.repostatus.org/badges/latest/active.svg}}
  which indicates whether this package is maintained regularly or
  forgotten in the abyss of internet.
\item
  The development version:
  \href{https://github.com/TGuillerme/dispRity}{\includegraphics{https://img.shields.io/badge/devel\%20version-1.2.1-green.svg?style=flat}}
  which indicates which version of the package you are about to install.
\end{itemize}
